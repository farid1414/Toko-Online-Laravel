        ...
        <div class="d-flex" id="wrapper" data-aos="fade-right">
            ...
            <div class="border-right" id="sidebar-wrapper">
                <div class="sidebar-heading text-center">
                    <img src="{{ asset('/image/admin.png') }}" class="w-100 my-4" alt="" />
                </div>
                <div class="list-group list-group-flush">
                    <a href="{{ route('admin-dashboard') }}"
                        class="list-group-item list-group-item-action {{ request()->is('admin/dashboard') ? 'active' : '' }}">Dashboard</a>
                    <a href=""
                        class="list-group-item list-group-item-action {{ request()->is('admin/kategori/index') ? 'active' : '' }}">Produk</a>
                    <a href="{{ route('kategori.index') }}"
                        class="list-group-item list-group-item-action {{ request()->is('admin/kategori', 'admin/kategori/create') ? 'active' : '' }}">Kategori</a>
                    <a href="{{ route('carousel.index') }}"
                        class="list-group-item list-group-item-action {{ request()->is('admin/carousel', 'admin/carousel/create') ? 'active' : '' }}">Carousel</a>
                    <a href=""
                        class="list-group-item list-group-item-action {{ request()->is('toko/produk', 'toko/tambah-produk', 'toko/edit-produk/') ? 'active' : '' }}">Transaksi</a>
                    <a href=""
                        class="list-group-item list-group-item-action {{ request()->is('toko/pengaturan-toko') ? 'active' : '' }}">User</a>
                    {{-- <a
